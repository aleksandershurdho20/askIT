            ...
            <div className="flex w-1/2 justify-center items-center bg-white">
                <form className="bg-white">
                    ...
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 text-gray-400" >
                        ...
                        <input className="pl-2 outline-none border-none text-black" type="text" placeholder="Email Address" />
                    </div>
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl text-gray-400">
                        ...
                        <input className="pl-2 outline-none border-none text-black " type="text" placeholder="Password" />
                    </div>
