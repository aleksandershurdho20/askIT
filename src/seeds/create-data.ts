...
export default class createAta implements Seeder {
    public async run(_: any, connection: Connection): Promise<any> {
        ...
        const john = await getRepository(User).findOne({ username: 'john' })
        const jane = await getRepository(User).findOne({ username: 'jane' })
        ...
        const reactJsSub = await getRepository(Sub).findOne({ where: { name: 'reactjs' } })
        const funnySub = await getRepository(Sub).findOne({ where: { name: 'funny' } })
        const iqSub = await getRepository(Sub).findOne({ where: { name: 'InsightfulQuestions' } })
        const oneliners = await getRepository(Sub).findOne({ where: { name: 'oneliners' } })
        ...
        await connection
            ...
            .values([
                ...
                },
                {
                    ...
                    user: john,
                    sub: reactJsSub,
                    createAt: timePlus(hour + minute * 30),
            ...
            any advice to help me to take the step?`,
                    user: john,
                    sub: iqSub,
                    createAt: timePlus(hour + minute * 40),
                ...
                },
                {
                    ...
                    user: john,
                    sub: funnySub,
                    createAt: timePlus(10 * day + 2 * hour),
                ...
                },
                {
                    ...
                    user: jane,
                    sub: oneliners,
                    createAt: timePlus(day + 8 * hour),
                    updatedAt: timePlus(day + 8 * hour),
                },
            ])
            .execute()

        const post6 = await getRepository(Post).findOne(6)
        const post7 = await getRepository(Post).findOne(7)
        const post8 = await getRepository(Post).findOne(8)
        const post9 = await getRepository(Post).findOne(9)
            ...
            .values([
                {
                    ...
                    user: john,
                    identifier: 'wZ9m66zb',
                    createAt: timePlus(10 * day + 5 * hour),
                ...
                },
                {
                    ...
                    user: jane,
                    identifier: 'G9ntregv',
                    createAt: timePlus(10 * day + 3 * hour),
                ...
                },
                {
                    ...
                    user: john,
                    identifier: 'JFd7haNZ',
                    createAt: timePlus(9 * day + hour * 2),
                ...
                },
                {
                    ...
                    user: jane,
                    identifier: 'MCqqWy8r',
                    createAt: timePlus(10 * day + 4 * hour),
                ...
                },
                {
                    ...
                    user: jane,
                    identifier: 'VxnlwvEx',
                    createAt: timePlus(10 * day + 7 * hour),
                    updatedAt: timePlus(10 * day + 7 * hour),
                },
            ])
            .execute()

        const comment1 = await getRepository(Comment).findOne(1)
        const comment2 = await getRepository(Comment).findOne(2)
